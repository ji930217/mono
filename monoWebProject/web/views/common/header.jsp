...
<style>
 ...
 #info, #memberInfoBtn, #memberLogoutBtn{
 display:inline-block;
 font-weight:bold;
 }
 #memberInfoBtn, #memberLogoutBtn{
 cursor:pointer;
 }
  </style>
  <script>
  ...
  function monoPage(){
	 /*  location.href="/mono/views/common/mono.jsp"; */
	  location.href="/mono/views/report/report.jsp";
  }
  ...
  function loginPage(){
	  location.href="/mono/views/member/memberLogin.jsp";
  }
  function faqPage(){
	  location.href="/mono/views/faq/faq.jsp";
  }
  function logout(){
	  location.href = "/mono/memberLogout.do";
  }
  function myInfo(){
	  location.href="/mono/views/member/memberUpdate.jsp";
  }
  function partnersList(){
	  location.href="/mono/views/partners/partnersList.jsp";
  }
  </script>
</head>
<body>
	...
	<div class="menu">
		...
		<%if(member == null){ %>
			...
			<div id = "info"><%=member.getMemberName()%>님이 로그인하셨습니다</div>&emsp;
				<div id = "memberInfoBtn" onclick = "myInfo();">정보수정</div>&emsp;
				<div id = "memberLogoutBtn" onclick = "logout();">LOGOUT</div>
				...
				<div class="left">
					<ul class="navi">
						...
						<li>
							...
							<ul>
								<li>경매</li>
								<li onclick = "partnersList();">업체지정</li>			
							</ul>
						</li>
						<li>
							BOARD
